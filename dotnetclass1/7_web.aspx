...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <li class="nav-item">
        <a class="nav-link" href="deafult.aspx">Overview</a>
    </li>
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade" id="nav-question" role="tabpanel" aria-labelledby="nav-question-tab">
                <div class="p-3">
                    <ol>
                        ...
                        <li class=" mb-3">Use different Client side Validation of Control for the following details.<br />
                            i. Employee_Id: Use Required Field Validator
                            <br />
                            ii. Employee_Name: Use RequiredField Validator
                            <br />
                            iii. Salary: RangeValidator
                        </li>
                        <li>Write the .NET Code for the following. [5]
                            <br />
                            <img src="img/7_Webapplication/2015.png" width="300" class="img-thumbnail" />
                        </li>
                        <li>Write the .NET Code for the following? [6]
                            <br />
                            <img src="img/7_Webapplication/2017.png" class="img-thumbnail" width="300" />
                        </li>
                        <li>Write the .NET code for navigating the data using DataSet for the following. [6]
                            <br />
                            <img src="img/7_Webapplication/2015%20Chance.png" width="300" class="img-thumbnail" />
                        </li>
                        <li>Write the .NET Code for the following. Verify that password must not exceed length 6 and it must consist of characters and at least a number. [6]<br />
            ...
            <div class="tab-pane fade" id="nav-notes" role="tabpanel" aria-labelledby="nav-notes-tab">
                <div class="p-3 text-justify">
                    ...
                    Validation controls are very useful while submitting data into a database table. These controls prevent users from submitting the wrong type of data.
                    <br />
                    <br />
                ...
                <ol>
                    ...
                    The RequiredFieldValidator control ensures that the input field is not empty.
                    <br />
                    <br />
                    The Syntax of the control is given:<br />
                    <img src="img/7_Webapplication/RequiredFieldValidator.png" class=" img-thumbnail border-danger w-auto" /><br />
                    <br />
                    ...
                    RangeValidator confirms that user input data is within a specified range of values.
                    <br />
                    The input value should come between a certain minimum and maximum value otherwise it will give error.
                    <br />
                    <br />
                    The Syntax of the control is given:<br />
                    <img src="img/7_Webapplication/RangeValidator.png" class=" img-thumbnail border-danger" /><br />
                    <br />
                    ...
                    CompareValidator control is used to compare the value of one form field against another field or with a fixed value.
                    <br />
                    <br />
                    The Syntax of the control is given:<br />
                    <img src="img/7_Webapplication/Compare.png" class=" img-thumbnail border-danger" /><br />
                    <br />
                    ...
                    <img src="img/7_Webapplication/RegularExpressionValidator.png" class=" img-thumbnail border-danger" /><br />
                    <br />
                    <br />

                    <h6 class="text-primary">5.	CustomValidator</h6>
                    CustomValidator control enables you to create your own validation. The CustomValidator control performs validation, based upon the code, you write. We can write validation code that will be executed on the client side or with server-side validation.<br />
                    <br />
                    The Syntax for the control is as given:<br />
                    <img src="img/7_Webapplication/CustomValidator.png" class=" img-thumbnail border-danger" /><br />
                    <br />
                    <img src="img/7_Webapplication/ServerSide.png" class=" img-thumbnail border-danger" /><br />
                    <br />
                ...
                This control summarizes the error messages for all validation controls on a Web page in a single location. ValidationSummary control is useful when working with large forms.
                    <br />
                    <br />
                    <div class="border w-75">
