<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="dotnetclass1.WebForm1" %>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-syllabus" role="tabpanel" aria-labelledby="nav-syllabus-tab">
                ...
                <div class="row">
                    ...
                    <div class="p-3 col-6">
                        <h6><strong>1. Overview of VB.NET and C# .NET Language (4hr)</strong></h6>
                        <ol>
                    ...
                    <div class="p-3 col-6">
                        ...
                        <ol>
                            ...
                            <li>Compilation and Execution Process in .NET Technology</li>
                            <li>IDE</li>
                            <li>Introduction to C#</li>
                            <li>Difference between C# and VB.NET</li>
            ...
            <div class="tab-pane fade" id="nav-notes" role="tabpanel" aria-labelledby="nav-notes-tab">
                <div class="p-3 text-justify">
                    ...
                    <p>Applications that are developed by using a particular version of the .NET Framework can run without modificaiton on a later version.</p>
                    <br />

                    <h6>6.	Easy deployment</h6>
                    <p>The .NET Framework provides easy deployment of applications by installing new applications or components that do not have an adverse effect on the existing applications. </p>
                    <br />
                    ...
                    <img src="img/1_Overview/framework.png" alt=".NET Framework Architecture" class="img-thumbnail border-primary" /><br />
                    <br />
            ...
            It is the run-time environment in the .NET Framework that runs the codes and helps in making the development process easier by providing following additional services.
                    ...
                    <p>
                        ...
                        Programmer need not to worry about on managing the memory if the programs are running under the CLR as it provides memory management. Programmatically, when our program needs memory, CLR allocates the memory.<br />
                        <br />

                        - Garbage Collection
                        <br />
                        Garbage Collection automatically release memory of unused objects in an application and can be done by CLR.<br />
                        <br />
                        ...
                        - Security
                        <br />
                        CLR enforces security permissions at code level security, folder level security, and machine-level security.<br />
                        <br />
                    ...
                    <img src="img/1_Overview/compilation%20process.png" class="img-thumbnail border-primary" /><br />
                    <br />
              ...
              The name "C sharp" was inspired by the musical notation where a sharp indicates that the written note should be made a semitone higher in pitch. This is similar to the language name of C++, where "++" indicates that a variable should be incremented by 1 after being evaluated. The sharp symbol also resembles a ligature of four "+" symbols (in a two-by-two grid), further implying that the language is an increment of C++.
                    ...
                    <div class="row">
                        <div class="col-6">
                            <img src="img/1_Overview/csharp.png" class="img-thumbnail" /><br />
                            <br />
                        </div>
                        <div class="col-6">
                    ...
                    <h5 class="text-danger">Difference between C# and VB.NET</h5>
                    <br />
            ...
            <div class="tab-pane fade" id="nav-photos" role="tabpanel" aria-labelledby="nav-photos-tab">
                ...
                <div class="p-3">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <img src="img/1_Overview/NetFramework.png" class="img-thumbnail" />
                        </div>

                        <div class="col-4">
                            <img src="img/1_Overview/garbageCollection.png" class="img-thumbnail" />
                        </div>
