 ...
 <div class="p-3 " >
        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          <div class="tab-pane fade" id="nav-notes" role="tabpanel" aria-labelledby="nav-notes-tab">
              ...
              <ol>
                  <li class="pb-2">Stored procedure is a group of sql statement that has been created once and stored in server database. <br /> A function is used for doing calculation instead of doing query.</li>
                  <li class="pb-2">Stored procedures may or may not return values. <br /> - Select query will return value. <br /> - Insert, update & delete will not return value. <br /> But function should return value. </li>
